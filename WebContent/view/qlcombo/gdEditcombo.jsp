				...
				<div class="right">
					<div class="right__content">
						...
						<div class="right__formWrapper">
							...
							<label>Id :</label>
									<input type="text" placeholder="Nhập id combo" id="idcombo" value="${combo.id }"
								...
								<div class="right__inputWrapper">
									<select name="moTa">
										<option value="${combo.moTa }">${combo.moTa }</option>
								...
								<table>
									...
									<tbody>
										<tr>											
											...
											<td data-label="Xoá" class="right__iconTable"><a href="/QLNhaHang/admin/xoamonancomboupdate?id=${comBoMonAn.id}&idcombo=${combo.id}"><img src="/QLNhaHang/view/static2/assets/icon-trash-black.svg" alt=""></a></td>                                  
										</tr>
									</tbody>
									</c:forEach>									
								</table>
