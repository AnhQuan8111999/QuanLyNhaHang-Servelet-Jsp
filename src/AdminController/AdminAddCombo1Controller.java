...
@WebServlet(urlPatterns = "/admin/addcombo1")
public class AdminAddCombo1Controller extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/view/qlcombo/gdthemcombo1.jsp").forward(req, resp);
	}
}
